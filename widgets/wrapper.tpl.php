<div class="widget<?php if ($widget['class_wrap']) { ?> <?php echo ltrim($widget['class_wrap'], '.');  } ?>">
    ...
    <?php if ($widget['title'] && $is_titles){ ?>
        <div class="widget_title<?php if ($widget['class_title']) { ?> <?php echo ltrim($widget['class_title'], '.');  } ?>">
    ...
    <div class="widget_body<?php if ($widget['class']) { ?> <?php echo ltrim($widget['class'], '.');  } ?>">
